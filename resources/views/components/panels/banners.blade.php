        ...
        <div data-slick-carousel>
            @foreach ($banners as $banner)
                <div class="relative banner">
                    <div class="w-full h-full bg-black"><img class="w-full h-full object-cover object-center opacity-70" src="{{ Storage::url($banner->image) }}" alt="{{ $banner->title }}" title="{{ $banner->title }}"></div>
